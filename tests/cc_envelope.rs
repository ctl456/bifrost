...
use bifrost::wire::{SUPPORTED, SequenceEntropy, WireAdapter, WireContext, adapter_for};
...
fn a_fingerprint_rides_alongside_the_event_with_the_same_headers() {
    let fingerprint = bifrost::fingerprint::generate_fingerprint("user_abc123", "salt", &DeviceProfile::default());
