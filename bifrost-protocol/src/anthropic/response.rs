...
//!   moment the block ends — see [`crate::anthropic::signature`].
//!
...
use bifrost_core::{CanonicalResponse, ChunkGenerator, ContentBlock, Error, FinishReason, OutputChunk, Usage};
use serde_json::{Map, Value, json};

use crate::adapter::ResponseMeta;
use crate::anthropic::signature::fake_thinking_signature;
...
mod tests {
    use super::*;
    use bifrost_core::{OutputAccumulator, Usage};
