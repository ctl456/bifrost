...
use bifrost_core::OutputChunk;
use bifrost_protocol::anthropic::AnthropicStreamRenderer;
use bifrost_protocol::anthropic::response::error_frame;
...
fn decoder_error(case: &Value) -> bifrost_core::Error {
    let mut decoder = CcDecoder::new();
