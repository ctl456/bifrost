...
pub use model::{
    AccessConfig, AdapterId, CONFIG_VERSION, Config, DeviceConfig, FingerprintConfig, LimitsConfig, LogFormat,
    LogLevel, MechanismsConfig, ModelsConfig, TelemetryConfig, WireConfig,
};
...
impl Config {
    ...
    /// [`REDACTED`] the same way the access line keeps a key's fingerprint instead
    /// of the key.
