...
impl Edge {
    ...
    ///
    /// Separate from [`Edge::wire_context`] so the access line can name the same
    ...
    pub fn encode(
        ...
        context: &WireContext,
    ) -> Result<crate::wire::WireRequest, crate::core::ConversionError> {
...
mod tests {
    use super::*;
    use crate::config::MechanismsConfig;
